...
const questNum:any = window.prompt("Input the number of total questions")
...
const App = () => {
  ...
  return (
    <div className='w-[75vw] md:w-[55vw] lg:w-[50vw] mx-auto px-5 h-[75vh] md:h-[65vh] text-center bg-white rounded-md shadow-lg overflow-hidden'>
      <h1 className="text-blue-800 bg-white font-qs text-3xl py-5 text-center font-bold">Quiz Test</h1>
      <>
